        ...
        <div class="">
            ...
            <div class="text-surat">
                ...
                <table class="ms-4" width="100%">
                    <?php foreach ($data as $d) { ?>
                        ...
                        <tr>
                            ...
                            <td>: </td>
                            <td><?= $d->tempat_lahir ?>, <?= formatTanggal($d->tgl_lahir) ?></td>
                        </tr>
                        <tr>
                            <td>Jenis Kelamin</td>
                            <td>: </td>
                ...
                <p style="text-align: justify;">
                    Demikian ini menerangkan bahwa benar yang bersangkutan berdomisili di Desa
                    Tunjung, Kecamatan Jatilawang, Kabupaten Banyumas.
                </p>
                <?php foreach ($data as $d) { ?>
                    <p>Surat keterangan ini dibuat berdasarkan keperluan <span class="fw-bold"><?= $d->keperluan ?>.</span>
                    </p>
                <?php } ?>
                <p style="text-align: justify;">
                ...
                <br>
                <div class=" float-end">
                    <div class="col-12 text-center float-end" style="padding:0 !important; margin:0; >
