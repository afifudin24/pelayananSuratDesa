                ...
                <table class="ms-5">
                    <?php foreach ($data as $d) { ?>
                        ...
                        <tr>
                            <td>Berlaku Mulai</td>
                            <td>: </td>
                            <td>Tgl <span class="fw-bold"><?= $d->tanggal_surat ?></span> s/d <span
                                    class="fw-bold"><?= $d->tanggal_kadaluarsa ?></span></td>
                        </tr>
                    <?php } ?>
                </table>
                <br>
                <p style="text-align: justify;">
                    Dengan demikian untuk menjadikan maklum bagi yang berkepentingan.
                </p>
