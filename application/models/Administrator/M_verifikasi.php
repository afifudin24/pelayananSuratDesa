...
class M_verifikasi extends CI_Model
{
    ...
    public function skrmverif($data, $id)
    {
        $this->db->where('id', $id);
        $this->db->set($data);
    ...
    public function komentarskrm($data, $id)
    {
        $this->db->where('id', $id);
        $this->db->set($data);
        $this->db->update('surat_keramaian');
    ...
    public function getPreviewSkrm($id)
    {
        $this->db->where('id', $id);
    ...
    public function hKeramaian($id)
    {
        $this->db->where('id', $id);
        $this->db->delete('surat_keramaian');
    }
