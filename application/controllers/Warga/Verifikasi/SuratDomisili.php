...
class SuratDomisili extends CI_Controller
{
    ...
    {
        // $data['title'] = 'Verifikasi Surat Domisili';
        // $data['surat'] = $this->M_surat->get_skd($id);
        $iddecode = $this->custom_decode($id);
        $surat =  $this->M_surat->get_skd($iddecode);
          if (!$surat) {
            show_error('Surat tidak ditemukan.');
        }

        // Data yang digunakan saat tanda tangan digital
        ...
        // $this->load->view('warga/verifikasi/surat_domisili');
    }
