    ...
    <div class="col-11 mx-auto">
        <div class="">
            ...
            <div class="text-surat">
                ...
                <br>
                <?php foreach ($data as $d) { ?>
                    <p>Berdasarkan pengamatan kami bahwa yang bersangkutan benar - benar memiliki usaha<span
                            class="fw-bold"><?= $d->nama_usaha ?></span> yang beralamat di
                        <span class="fw-bold"><?= $d->alamat_usaha ?></span>.
                    </p>
                <?php } ?>
                <br>
