...
class M_count extends CI_Model
{
    ...
    public function dPskrm()
    {
        return $this->db->get('surat_keramaian')->num_rows();
    }
    ...
    public function mvSkrm()
    {
        $query = $this->db->query("SELECT COUNT(*) AS jumlah FROM surat_keramaian WHERE status = 'Menunggu Verifikasi'");
        return $query->row_array();
    }
    ...
    public function pdSkrm()
    {
        $query = $this->db->query("SELECT COUNT(*) AS jumlah FROM surat_keramaian WHERE status = 'Diterima'");
        return $query->row_array();
    }
    ...
    public function ptSkrm()
    {
        $query = $this->db->query("SELECT COUNT(*) AS jumlah FROM surat_keramaian WHERE status = 'Ditolak'");
        return $query->row_array();
    }
}
