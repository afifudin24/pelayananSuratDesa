		...
		<?php } else if ($this->session->userdata('role_id') == 3) { ?>
					<div class="row mb-4">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body bg-success">
									<h4 class="font-bold text-white">SELAMAT DATANG DI APLIKASI PELAYANAN SURAT DESA TUNJUNG -
										JATILAWANG</h4>
									<h5 class="font-bold text-white"></h5>
								</div>
							</div>
							<div class="card mt-2">
											...
											<div class="col-sm-6">
												...
												<div class="card">
													<div class="card-body">
														...
														<p class="card-text text-dark ml-3">Silahkan cetak surat pada menu Surat dan
															cek komentar untuk cek data yang tidak lengkap, kemudian lakukan request
															surat kembali.</p>
													</div>
												</div>
											</div>
